...
public class AdminLoggerConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> LOG_DIRECTORY;
    public static final ForgeConfigSpec.IntValue MAX_LOG_SIZE_MB;
    public static final ForgeConfigSpec.ConfigValue<String> LOG_FORMAT;
    public static final ForgeConfigSpec.BooleanValue LOG_GLOBAL_INDEX;
    public static final ForgeConfigSpec.BooleanValue USE_UUID_FOLDERS;
    public static final ForgeConfigSpec.BooleanValue INCLUDE_PLAYER_UUID;
    public static final ForgeConfigSpec.BooleanValue LOG_CHAT;
    public static final ForgeConfigSpec.BooleanValue LOG_COMMANDS;
    public static final ForgeConfigSpec.BooleanValue LOG_INVENTORY;
    ...
    public static final ForgeConfigSpec.BooleanValue LOG_GAME_MODE;
    public static final ForgeConfigSpec.BooleanValue LOG_TELEPORTS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> IGNORED_PLAYERS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> IGNORED_WORLDS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> IGNORED_COMMANDS;
    public static final ForgeConfigSpec.BooleanValue ENABLE_ALERTS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> ALERT_EVENT_TYPES;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> WATCHED_PLAYERS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> WATCHED_COMMANDS;
    public static final ForgeConfigSpec.BooleanValue BROADCAST_ALERTS_TO_OPS;
    public static final ForgeConfigSpec.BooleanValue WRITE_ALERT_LOG;
    public static final ForgeConfigSpec.BooleanValue DISCORD_WEBHOOK_ENABLED;
    public static final ForgeConfigSpec.ConfigValue<String> DISCORD_WEBHOOK_URL;
    public static final ForgeConfigSpec.ConfigValue<String> DISCORD_WEBHOOK_USERNAME;
    public static final ForgeConfigSpec.BooleanValue MASK_SENSITIVE_COMMANDS;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> SENSITIVE_COMMAND_TERMS;
